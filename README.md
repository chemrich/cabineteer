...
```bash
uv run python -m evals                       # <!--stat:scenarios-->313<!--/stat:scenarios--> scenarios / <!--stat:assertions-->1,224<!--/stat:assertions--> typed assertions on real output numbers
...
uv run python -m evals         # <!--stat:scenarios-->313<!--/stat:scenarios--> scenarios / <!--stat:assertions-->1,224<!--/stat:assertions--> assertions, runs in ~1 second
```
